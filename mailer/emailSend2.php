...
{ 
	...
	$mailer_error = 'emailSend2.php - Sorry, you have to choose a PDF file to upload';
...
{ 
	...
	include $mailer_files.'displayResultHdr.html';
	$mailer_error = 'emailSend2.php - Sorry, you can only attach PDF files';
	include $mailer_files.'displayErrorDtl.html';
	include $mailer_files.'displayResultFtr.html';
	exit();
}
...
{ 
 	//trigger_error( 'Error getting PDF file contents', E_USER_ERROR ); 
	include $mailer_files.'displayResultHdr.html';
	$mailer_error = 'emailSend2.php - Error getting PDF file contents';
	include $mailer_files.'displayErrorDtl.html';
	include $mailer_files.'displayResultFtr.html';
	exit();
}
...
{ 
	//trigger_error( 'Sorry, you have to choose an HTML file to upload', E_USER_ERROR ); 
	include $mailer_files.'displayResultHdr.html';
	$mailer_error = 'emailSend2.php - Sorry, you have to choose an HTML file to upload';
	include $mailer_files.'displayErrorDtl.html';
	include $mailer_files.'displayResultFtr.html';
	exit();
} 
if ( false === strpos($_FILES['html_file']['type'], 'htm')) 
{ 
 	//trigger_error( 'Sorry, you can only upload HTML files', E_USER_ERROR ); 
	include $mailer_files.'displayResultHdr.html';
	$mailer_error = 'emailSend2.php - Sorry, you can only upload HTML files';
	include $mailer_files.'displayErrorDtl.html';
	include $mailer_files.'displayResultFtr.html';
	exit();
} 

if ( !($html_file = file_get_contents($_FILES['html_file']['tmp_name'])) ) 
{ 
 	//trigger_error( 'Error getting file contents', E_USER_ERROR ); 
	include $mailer_files.'displayResultHdr.html';
	$mailer_error = 'emailSend2.php - Error getting HTML file contents';
	include $mailer_files.'displayErrorDtl.html';
	include $mailer_files.'displayResultFtr.html';
	exit();
}
...
else
{
	...
	include $mailer_files.'displayResultHdr.html';
	$mailer_error = 'emailSend2.php - You can\'t see this page without submitting the form.';
	include $mailer_files.'displayErrorDtl.html';
	include $mailer_files.'displayResultFtr.html';
	exit();
}

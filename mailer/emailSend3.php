...
{ 
	...
	$mailer_error = 'emailSend3.php - Sorry, you have to choose a file to upload';
...
{ 
	...
	include $mailer_files.'displayResultHdr.html';
	$mailer_error = 'emailSend3.php - Sorry, you can only upload HTML files';
	include $mailer_files.'displayErrorDtl.html';
	include $mailer_files.'displayResultFtr.html';
	exit();
} 
...
{ 
	...
	include $mailer_files.'displayResultHdr.html';
	$mailer_error = 'emailSend3.php - Error getting file contents';
	include $mailer_files.'displayErrorDtl.html';
	include $mailer_files.'displayResultFtr.html';
	exit();
}
...
else
{
	...
	include $mailer_files.'displayResultHdr.html';
	$mailer_error = 'emailSend3.php - You can\'t see this page without submitting the form.';
	include $mailer_files.'displayErrorDtl.html';
	include $mailer_files.'displayResultFtr.html';
	//	exit();
}
